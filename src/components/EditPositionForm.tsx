...
export function EditPositionForm({
  ...
  // Compute total equity excluding the position being edited (so preview is accurate)
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!position || !ticker || !shares || !entryPrice || !stopPrice) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-gray-800 rounded-lg shadow-lg p-6 w-full max-w-2xl max-h-screen overflow-y-auto border border-gray-700">
        <h2 className="text-2xl font-bold mb-4 text-white">Edit Position</h2>
